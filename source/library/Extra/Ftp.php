...
class Extra_Ftp
{
    ...
    {
        // Luego creamos un login al mismo con nuestro usuario y contrase̱a
        $this->_cidftp = ftp_connect($this->_host);
    ...
    public function upImage ($ruta, $file)
    {
        ...
        ftp_chmod($this->_cidftp, 0755, $ruta);
    }
    ...
    function recursiveDelete ($directory)
    {
        ...
        if ( !(@ftp_rmdir($this->_cidftp, $directory) || @ftp_delete($this->_cidftp, $directory)) ) {
        # if the attempt to delete fails, get the file listing
        $filelist = @ftp_nlist($this->_cidftp, $directory);
